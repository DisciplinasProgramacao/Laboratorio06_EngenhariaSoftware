...
def collect_data(total_repos=1000, batch_size=20):
    cursor = None
    all_repos = []
...
def save_to_csv(repos):
    with open('github_repositories_1000.csv', 'w', newline='') as csvfile:
...
if __name__ == '__main__':
    repos = collect_data(total_repos=1000, batch_size=20)
    save_to_csv(repos)
